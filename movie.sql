...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1812190875ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=movie&table=movie">`movie`.`movie`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=applicant&table=data">`applicant`.`data`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=applicant&table=login">`applicant`.`login`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=student_db&table=schedule">`student_db`.`schedule`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="7b776c5246266e762b495d2c2a382277">
...
<div id="topmenucontainer" class="menucontainer">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="student_db" targettable="schedule">
            ...
            Queried time
                            ...
                            targetdb="applicant" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `data` (
  `email` varchar(256) NOT NULL,
  `fullname` varchar(256) NOT NULL,
  `place of birth` varchar(256) NOT NULL,
  `date of birth` date NOT NULL,
  `college_entrance` varchar(256) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="applicant" targettable="data">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `login` (
  ...
  `password` varchar(256) NOT NULL
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `login` (`username`, `password`) VALUES
(&#039;admin&#039;, &#039;admin&#039;),
(&#039;admin2&#039;, &#039;admin&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `data`
  ADD PRIMARY KEY (`email`);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="applicant" targettable="">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `data` (`email`, `fullname`, `place of birth`, `date of birth`, `college_entrance`) VALUES
(&#039;achmadmutawazin@gmail.com&#039;, &#039;achmad azril mutawazin&#039;, &#039;Cirebon&#039;, &#039;2002-04-14&#039;, &#039;SBMPTN&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="applicant" targettable="data">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SET time_zone = &quot;+00:00&quot;;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="movie" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `movie` (
  ...
  `score` double NOT NULL
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="movie" targettable="movie">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `movie` (`title`, `plot`, `character`, `acting`, `score`) VALUES
(&#039;KKN at Dancer Village&#039;, 4, 5, 5, 4.666666666666667),
(&#039;Minion 5 : Escaping&#039;, 3, 5, 3, 3.6666666666666665),
(&#039;Quiet Place&#039;, 5, 5, 2, 4);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="movie" targettable="movie">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `movie`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="applicant" targettable="login">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
